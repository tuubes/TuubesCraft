...
final class PlayerPositionAndLookPacket(var x: Double, var feetY: Double, var z: Double, var yaw: Float, var pitch: Float, var onGround: Boolean) extends Packet[CraftAttach] {

...
final class SpawnMobPacket(var entityId: Int, var entityUuid: UUID, var type: Int, var x: Double, var y: Double, var z: Double, var yaw: Byte, var pitch: Byte, var headPitch: Byte, var velocityX: Short, var velocityY: Short, var velocityZ: Short, var metadata: AnyRef) extends Packet {
  ...
  override def id = SpawnMobPacket.id
...
object SpawnMobPacket extends PacketObj[SpawnMobPacket] {
  override val id = 3
	
  override def read(in: NiolOutput): SpawnMobPacket {
...
final class SpawnMobPacketBuilder[P <: SpawnMobPacket] extends PacketBuilder[SpawnMobPacket, Complete] {
...
object SpawnMobPacketBuilder {
  ...
  type Complete = SpawnMobPacketBuilder with EntityId with EntityUuid with Type with X with Y with Z with Yaw with Pitch with HeadPitch with VelocityX with VelocityY with VelocityZ with Metadata
}

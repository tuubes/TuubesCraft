...
final class UnlockRecipesPacket(var action: Int, var craftingBookOpen: Boolean, var filteringCraftable: Boolean, var recipeIds: Array[Int], var arraySize2: Option[Int], var recipeIds: Option[Array[???]]) extends Packet {
  ...
  override def id = UnlockRecipesPacket.id

	
}
object UnlockRecipesPacket extends PacketObj[UnlockRecipesPacket] {
  override val id = 48
	
  override def read(in: NiolOutput): UnlockRecipesPacket {
...
final class UnlockRecipesPacketBuilder[P <: UnlockRecipesPacket] extends PacketBuilder[UnlockRecipesPacket, Complete] {
...
object UnlockRecipesPacketBuilder {
  ...
  sealed trait RecipeIds
  type Complete = UnlockRecipesPacketBuilder with Action with CraftingBookOpen with FilteringCraftable with RecipeIds with ArraySize2 with RecipeIds
}

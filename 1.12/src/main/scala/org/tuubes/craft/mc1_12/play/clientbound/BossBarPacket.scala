...
final class BossBarPacket(var uuid: UUID, var action: Int, var title: String, var health: Float, var color: Int, var division: Int, var flags: Int, var noFields: Nothing, var health: Float, var title: String, var color: Int, var dividers: Int, var flags: Int) extends Packet {
  ...
  override def id = BossBarPacket.id

	
}
object BossBarPacket extends PacketObj[BossBarPacket] {
  override val id = 12
	
  override def read(in: NiolOutput): BossBarPacket {
...
final class BossBarPacketBuilder[P <: BossBarPacket] extends PacketBuilder[BossBarPacket, Complete] {
...
object BossBarPacketBuilder {
  ...
  sealed trait Flags
  type Complete = BossBarPacketBuilder with Uuid with Action with Title with Health with Color with Division with Flags with NoFields with Health with Title with Color with Dividers with Flags
}

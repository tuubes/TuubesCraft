...
final class RespawnPacket(var dimension: Int, var difficulty: Int, var gamemode: Int, var levelType: String) extends Packet {
  ...
  override def id = RespawnPacket.id

	
}
object RespawnPacket extends PacketObj[RespawnPacket] {
  override val id = 52
	
  override def read(in: NiolOutput): RespawnPacket {
...
final class RespawnPacketBuilder[P <: RespawnPacket] extends PacketBuilder[RespawnPacket, Complete] {
...
object RespawnPacketBuilder {
  ...
  type Complete = RespawnPacketBuilder with Dimension with Difficulty with Gamemode with LevelType
}

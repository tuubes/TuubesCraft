...
import PrepareCraftingGridPacketBuilder._

/** Packet class auto-generated by DataTractor */
final class PrepareCraftingGridPacket(var windowId: Byte, var actionNumber: Short, var arraySize: Short, var item: AnyRef, var craftingSlot: Byte, var playerSlot: Byte, var arraySize: Short, var item: AnyRef, var craftingSlot: Byte, var playerSlot: Byte) extends Packet[CraftAttach] {
  ...
  override def obj = PrepareCraftingGridPacket

	
}
object PrepareCraftingGridPacket extends PacketObj[CraftAttach, PrepareCraftingGridPacket] {
  override val id = 1
	
  override def read(in: NiolInput): PrepareCraftingGridPacket = {
...
final class PrepareCraftingGridPacketBuilder[P <: PrepareCraftingGridPacket] extends PacketBuilder[PrepareCraftingGridPacket, P =:= Complete] {
...
object PrepareCraftingGridPacketBuilder {
  ...
  sealed trait CraftingSlot
  sealed trait PlayerSlot
  type Complete = PrepareCraftingGridPacket with WindowId with ActionNumber with ArraySize with Item with CraftingSlot with PlayerSlot with ArraySize with Item with CraftingSlot with PlayerSlot
}

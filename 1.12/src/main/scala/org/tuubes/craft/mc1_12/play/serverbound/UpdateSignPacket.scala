...
final class UpdateSignPacket(var location: Long, var line1: String, var line2: String, var line3: String, var line4: String) extends Packet {
  ...
  override def id = UpdateSignPacket.id
...
object UpdateSignPacket extends PacketObj[UpdateSignPacket] {
  override val id = 28
	
  override def read(in: NiolOutput): UpdateSignPacket {
...
final class UpdateSignPacketBuilder[P <: UpdateSignPacket] extends PacketBuilder[UpdateSignPacket, Complete] {
...
object UpdateSignPacketBuilder {
  ...
  sealed trait Line3
  sealed trait Line4
  type Complete = UpdateSignPacketBuilder with Location with Line1 with Line2 with Line3 with Line4
}

...
final class SpawnPositionPacket(var location: Long) extends Packet {
  override def write(out: NiolOutput): Unit {
    out.putLong(location)
  }
	
  override def id = SpawnPositionPacket.id
...
object SpawnPositionPacket extends PacketObj[SpawnPositionPacket] {
  override val id = 69
	
  override def read(in: NiolOutput): SpawnPositionPacket {
    val location = in.getLong()
    new SpawnPositionPacket(location)
  }
}
/** Packet builder auto-generated by DataTractor */
final class SpawnPositionPacketBuilder[P <: SpawnPositionPacket] extends PacketBuilder[SpawnPositionPacket, Complete] {
...
object SpawnPositionPacketBuilder {
  ...
  type Complete = SpawnPositionPacketBuilder with Location
}

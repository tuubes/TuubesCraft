...
import PlayerBlockPlacementPacketBuilder._

/** Packet class auto-generated by DataTractor */
final class PlayerBlockPlacementPacket(var location: Long, var face: Int, var hand: Int, var cursorPositionX: Float, var cursorPositionY: Float, var cursorPositionZ: Float) extends Packet[CraftAttach] {
  ...
  override def obj = PlayerBlockPlacementPacket
...
object PlayerBlockPlacementPacket extends PacketObj[CraftAttach, PlayerBlockPlacementPacket] {
  ...
  override def read(in: NiolInput): PlayerBlockPlacementPacket = {
...
final class PlayerBlockPlacementPacketBuilder[P <: PlayerBlockPlacementPacket] extends PacketBuilder[PlayerBlockPlacementPacket, P =:= Complete] {
...
object PlayerBlockPlacementPacketBuilder {
  ...
  type Complete = PlayerBlockPlacementPacket with Location with Face with Hand with CursorPositionX with CursorPositionY with CursorPositionZ
}

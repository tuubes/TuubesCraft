...
object HandshakePacket extends PacketObj[CraftAttach, HandshakePacket] {
  ...
  override def handle(packet: HandshakePacket, client: CraftAttach): Unit = {
    super.handle(packet, client)
    import org.tuubes.craft.mc1_12.status.StatusProtocol
    import org.tuubes.craft.mc1_12.login.LoginProtocol

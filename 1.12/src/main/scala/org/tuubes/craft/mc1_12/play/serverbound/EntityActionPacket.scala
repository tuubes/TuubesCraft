...
final class EntityActionPacket(var entityId: Int, var actionId: Int, var jumpBoost: Int) extends Packet {
  ...
  override def id = EntityActionPacket.id

	
}
object EntityActionPacket extends PacketObj[EntityActionPacket] {
  override val id = 21
	
  override def read(in: NiolOutput): EntityActionPacket {
...
final class EntityActionPacketBuilder[P <: EntityActionPacket] extends PacketBuilder[EntityActionPacket, Complete] {
...
object EntityActionPacketBuilder {
  ...
  type Complete = EntityActionPacketBuilder with EntityId with ActionId with JumpBoost
}

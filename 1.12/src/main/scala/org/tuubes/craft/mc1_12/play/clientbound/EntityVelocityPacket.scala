...
import EntityVelocityPacketBuilder._
import com.electronwill.niol.{NiolInput, NiolOutput}
import org.tuubes.craft.CraftAttach
import org.tuubes.core.network._

/** Packet class auto-generated by DataTractor */
final class EntityVelocityPacket(var entityId: Int, var velocityX: Short, var velocityY: Short, var velocityZ: Short) extends Packet[CraftAttach] {
...
object EntityVelocityPacket extends PacketObj[CraftAttach, EntityVelocityPacket] {
  override val id = 62
	
  override def read(in: NiolInput): EntityVelocityPacket = {
...
final class EntityVelocityPacketBuilder[P <: EntityVelocityPacket] extends PacketBuilder[EntityVelocityPacket, P =:= Complete] {
...
object EntityVelocityPacketBuilder {
  ...
  type Complete = EntityVelocityPacket with EntityId with VelocityX with VelocityY with VelocityZ
}

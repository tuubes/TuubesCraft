...
import PlayerDiggingPacketBuilder._

/** Packet class auto-generated by DataTractor */
final class PlayerDiggingPacket(var status: Int, var location: Long, var face: Byte) extends Packet[CraftAttach] {
...
object PlayerDiggingPacket extends PacketObj[CraftAttach, PlayerDiggingPacket] {
  override val id = 20
	
  override def read(in: NiolInput): PlayerDiggingPacket = {
...
final class PlayerDiggingPacketBuilder[P <: PlayerDiggingPacket] extends PacketBuilder[PlayerDiggingPacket, P =:= Complete] {
...
object PlayerDiggingPacketBuilder {
  ...
  sealed trait Face
  type Complete = PlayerDiggingPacket with Status with Location with Face
}

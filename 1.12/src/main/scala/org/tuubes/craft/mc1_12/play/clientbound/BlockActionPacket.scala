...
final class BlockActionPacket(var location: Long, var actionIdByte1: Int, var actionParamByte2: Int, var blockType: Int) extends Packet {
  ...
  override def id = BlockActionPacket.id
...
final class BlockActionPacketBuilder[P <: BlockActionPacket] extends PacketBuilder[BlockActionPacket, Complete] {
  ...
  def withActionId(Byte1)(actionIdByte1: Int): BlockActionPacketBuilder[P with ActionId(Byte1)] = {
    this.actionIdByte1 = actionIdByte1
    this.asInstanceOf[BlockActionPacketBuilder[P with ActionId(Byte1)]]
  }

  def withActionParam(Byte2)(actionParamByte2: Int): BlockActionPacketBuilder[P with ActionParam(Byte2)] = {
    this.actionParamByte2 = actionParamByte2
    this.asInstanceOf[BlockActionPacketBuilder[P with ActionParam(Byte2)]]
  }
...
object BlockActionPacketBuilder {
  ...
  sealed trait ActionId(Byte1)
  sealed trait ActionParam(Byte2)
  sealed trait BlockType
  type Complete = BlockActionPacketBuilder with Location with ActionId(Byte1) with ActionParam(Byte2) with BlockType
}

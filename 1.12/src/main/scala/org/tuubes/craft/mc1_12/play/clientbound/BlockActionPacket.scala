...
import BlockActionPacketBuilder._
import org.tuubes.craft.CraftAttach

/** Packet class auto-generated by DataTractor */
final class BlockActionPacket(var location: Long, var actionIdByte1: Int, var actionParamByte2: Int, var blockType: Int) extends Packet[CraftAttach] {
...
object BlockActionPacket extends PacketObj[CraftAttach, BlockActionPacket] {
  ...
  override def read(in: NiolInput): BlockActionPacket = {
...
final class BlockActionPacketBuilder[P <: BlockActionPacket] extends PacketBuilder[BlockActionPacket, P =:= Complete] {
...
object BlockActionPacketBuilder {
  ...
  type Complete = BlockActionPacket with Location with ActionIdByte1 with ActionParamByte2 with BlockType
}

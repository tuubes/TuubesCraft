...
final class UpdateHealthPacket(var health: Float, var food: Int, var foodSaturation: Float) extends Packet {
  ...
  override def obj = UpdateHealthPacket

	
}
object UpdateHealthPacket extends PacketObj[UpdateHealthPacket] {
  override val id = 64
	
  override def read(in: NiolOutput): UpdateHealthPacket = {
...
final class UpdateHealthPacketBuilder[P <: UpdateHealthPacket] extends PacketBuilder[UpdateHealthPacket, Complete] {
...
object UpdateHealthPacketBuilder {
  ...
  type Complete = UpdateHealthPacketBuilder with Health with Food with FoodSaturation
}

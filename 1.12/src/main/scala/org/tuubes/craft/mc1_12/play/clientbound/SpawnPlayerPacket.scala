...
final class SpawnPlayerPacket(var entityId: Int, var playerUuid: UUID, var x: Double, var y: Double, var z: Double, var yaw: Byte, var pitch: Byte, var metadata: AnyRef) extends Packet {
  ...
  override def id = SpawnPlayerPacket.id
...
object SpawnPlayerPacket extends PacketObj[SpawnPlayerPacket] {
  override val id = 5
	
  override def read(in: NiolOutput): SpawnPlayerPacket {
...
final class SpawnPlayerPacketBuilder[P <: SpawnPlayerPacket] extends PacketBuilder[SpawnPlayerPacket, Complete] {
...
object SpawnPlayerPacketBuilder {
  ...
  type Complete = SpawnPlayerPacketBuilder with EntityId with PlayerUuid with X with Y with Z with Yaw with Pitch with Metadata
}

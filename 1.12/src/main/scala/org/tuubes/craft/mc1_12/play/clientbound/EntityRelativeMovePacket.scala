...
final class EntityRelativeMovePacket(var entityId: Int, var deltaX: Short, var deltaY: Short, var deltaZ: Short, var onGround: Boolean) extends Packet {
  ...
  override def id = EntityRelativeMovePacket.id

	
}
object EntityRelativeMovePacket extends PacketObj[EntityRelativeMovePacket] {
  override val id = 38
	
  override def read(in: NiolOutput): EntityRelativeMovePacket {
...
final class EntityRelativeMovePacketBuilder[P <: EntityRelativeMovePacket] extends PacketBuilder[EntityRelativeMovePacket, Complete] {
...
object EntityRelativeMovePacketBuilder {
  ...
  type Complete = EntityRelativeMovePacketBuilder with EntityId with DeltaX with DeltaY with DeltaZ with OnGround
}

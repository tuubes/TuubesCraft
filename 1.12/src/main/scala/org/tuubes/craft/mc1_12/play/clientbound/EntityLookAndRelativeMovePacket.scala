...
final class EntityLookAndRelativeMovePacket(var entityId: Int, var deltaX: Short, var deltaY: Short, var deltaZ: Short, var yaw: Byte, var pitch: Byte, var onGround: Boolean) extends Packet {
  ...
  override def id = EntityLookAndRelativeMovePacket.id
...
object EntityLookAndRelativeMovePacket extends PacketObj[EntityLookAndRelativeMovePacket] {
  override val id = 39
	
  override def read(in: NiolOutput): EntityLookAndRelativeMovePacket {
...
final class EntityLookAndRelativeMovePacketBuilder[P <: EntityLookAndRelativeMovePacket] extends PacketBuilder[EntityLookAndRelativeMovePacket, Complete] {
...
object EntityLookAndRelativeMovePacketBuilder {
  ...
  type Complete = EntityLookAndRelativeMovePacketBuilder with EntityId with DeltaX with DeltaY with DeltaZ with Yaw with Pitch with OnGround
}

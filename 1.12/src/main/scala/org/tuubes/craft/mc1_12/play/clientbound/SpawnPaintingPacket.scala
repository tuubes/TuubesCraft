...
final class SpawnPaintingPacket(var entityId: Int, var entityUuid: UUID, var title: String, var location: Long, var direction: Byte) extends Packet {
  ...
  override def id = SpawnPaintingPacket.id
...
object SpawnPaintingPacket extends PacketObj[SpawnPaintingPacket] {
  override val id = 4
	
  override def read(in: NiolOutput): SpawnPaintingPacket {
...
final class SpawnPaintingPacketBuilder[P <: SpawnPaintingPacket] extends PacketBuilder[SpawnPaintingPacket, Complete] {
...
object SpawnPaintingPacketBuilder {
  ...
  type Complete = SpawnPaintingPacketBuilder with EntityId with EntityUuid with Title with Location with Direction
}

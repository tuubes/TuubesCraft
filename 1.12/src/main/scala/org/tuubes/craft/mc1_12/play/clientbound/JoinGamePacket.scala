...
import JoinGamePacketBuilder._
...
final class JoinGamePacket(var entityId: Int, var gamemode: Int, var dimension: Int, var difficulty: Int, var maxPlayers: Int, var levelType: String, var reducedDebugInfo: Boolean) extends Packet[CraftAttach] {
...
object JoinGamePacket extends PacketObj[CraftAttach, JoinGamePacket] {
  override val id = 35
	
  override def read(in: NiolInput): JoinGamePacket = {
    ...
    val reducedDebugInfo = in.getBool()
    new JoinGamePacket(entityId, gamemode, dimension, difficulty, maxPlayers, levelType, reducedDebugInfo)
  }
}
/** Packet builder auto-generated by DataTractor */
final class JoinGamePacketBuilder[P <: JoinGamePacket] extends PacketBuilder[JoinGamePacket, P =:= Complete] {
...
object JoinGamePacketBuilder {
  ...
  type Complete = JoinGamePacket with EntityId with Gamemode with Dimension with Difficulty with MaxPlayers with LevelType with ReducedDebugInfo
}

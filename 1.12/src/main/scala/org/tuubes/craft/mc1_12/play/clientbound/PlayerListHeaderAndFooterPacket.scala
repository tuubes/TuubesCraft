...
final class PlayerListHeaderAndFooterPacket(var header: String, var footer: String) extends Packet[CraftAttach] {
  override def write(out: NiolOutput): Unit = {
    out.putVarstring(header, UTF_8)
    out.putVarstring(footer, UTF_8)
  }
	
  override def obj = PlayerListHeaderAndFooterPacket

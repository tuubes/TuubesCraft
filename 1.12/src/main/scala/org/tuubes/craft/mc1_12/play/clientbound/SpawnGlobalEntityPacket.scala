...
import SpawnGlobalEntityPacketBuilder._
import org.tuubes.core.network._

/** Packet class auto-generated by DataTractor */
final class SpawnGlobalEntityPacket(var entityId: Int, var `type`: Byte, var x: Double, var y: Double, var z: Double) extends Packet[CraftAttach] {
...
object SpawnGlobalEntityPacket extends PacketObj[CraftAttach, SpawnGlobalEntityPacket] {
  override val id = 2
	
  override def read(in: NiolInput): SpawnGlobalEntityPacket = {
...
final class SpawnGlobalEntityPacketBuilder[P <: SpawnGlobalEntityPacket] extends PacketBuilder[SpawnGlobalEntityPacket, P =:= Complete] {
...
object SpawnGlobalEntityPacketBuilder {
  ...
  sealed trait Y
  sealed trait Z
  type Complete = SpawnGlobalEntityPacket with EntityId with Type with X with Y with Z
}

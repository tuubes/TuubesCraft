...
import EntityEffectPacketBuilder._
import com.electronwill.niol.{NiolInput, NiolOutput}
import org.tuubes.craft.CraftAttach
import org.tuubes.core.network._

/** Packet class auto-generated by DataTractor */
final class EntityEffectPacket(var entityId: Int, var effectId: Byte, var amplifier: Byte, var duration: Int, var flags: Byte) extends Packet[CraftAttach] {
  ...
  override def obj = EntityEffectPacket

	
}
object EntityEffectPacket extends PacketObj[CraftAttach, EntityEffectPacket] {
  override val id = 79
	
  override def read(in: NiolInput): EntityEffectPacket = {
...
final class EntityEffectPacketBuilder[P <: EntityEffectPacket] extends PacketBuilder[EntityEffectPacket, P =:= Complete] {
...
object EntityEffectPacketBuilder {
  ...
  sealed trait Flags
  type Complete = EntityEffectPacket with EntityId with EffectId with Amplifier with Duration with Flags
}

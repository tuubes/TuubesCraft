...
import EntityStatusPacketBuilder._
import org.tuubes.craft.CraftAttach
import org.tuubes.core.network._

/** Packet class auto-generated by DataTractor */
final class EntityStatusPacket(var entityId: Int, var entityStatus: Byte) extends Packet[CraftAttach] {
  override def write(out: NiolOutput): Unit = {
    out.putInt(entityId)
    out.putByte(entityStatus)
  }
	
  override def obj = EntityStatusPacket

	
}
object EntityStatusPacket extends PacketObj[CraftAttach, EntityStatusPacket] {
  override val id = 27
	
  override def read(in: NiolInput): EntityStatusPacket = {
...
final class EntityStatusPacketBuilder[P <: EntityStatusPacket] extends PacketBuilder[EntityStatusPacket, P =:= Complete] {
...
object EntityStatusPacketBuilder {
  ...
  type Complete = EntityStatusPacket with EntityId with EntityStatus
}

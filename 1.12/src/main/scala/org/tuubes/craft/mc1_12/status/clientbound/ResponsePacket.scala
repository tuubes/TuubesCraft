...
object ResponsePacket extends PacketObj[ResponsePacket] {
  override val id = 0
	
  override def read(in: NiolOutput): ResponsePacket = {
    val jsonResponse = in.getVarstring(UTF_8)
    new ResponsePacket(jsonResponse)
  }
}
/** Packet builder auto-generated by DataTractor */
final class ResponsePacketBuilder[P <: ResponsePacket] extends PacketBuilder[ResponsePacket, Complete] {
...
object ResponsePacketBuilder {
  ...
  type Complete = ResponsePacketBuilder with JsonResponse
}

...
import MapPacketBuilder._
import org.tuubes.craft.CraftAttach
import org.tuubes.core.network._

/** Packet class auto-generated by DataTractor */
final class MapPacket(var itemDamage: Int, var scale: Byte, var trackingPosition: Boolean, var iconCount: Int, var directionAndType: Byte, var x: Byte, var z: Byte, var columns: Byte, var rows: Option[Byte], var x: Option[Byte], var z: Option[Byte], var length: Option[Int], var data: Option[Array[Int]]) extends Packet[CraftAttach] {
  override def write(out: NiolOutput): Unit = {
    out.putVarint(itemDamage)
    out.putByte(scale)
    out.putBool(trackingPosition)
  ...
  override def obj = MapPacket

	
}
object MapPacket extends PacketObj[CraftAttach, MapPacket] {
  override val id = 36
	
  override def read(in: NiolInput): MapPacket = {
    val itemDamage = in.getVarint()
    val scale = in.getByte()
    val trackingPosition = in.getBool()
...
final class MapPacketBuilder[P <: MapPacket] extends PacketBuilder[MapPacket, P =:= Complete] {
...
object MapPacketBuilder {
  ...
  sealed trait Length
  sealed trait Data
  type Complete = MapPacket with ItemDamage with Scale with TrackingPosition with IconCount with DirectionAndType with X with Z with Columns with Rows with X with Z with Length with Data
}

...
object TeamsPacket extends PacketObj[CraftAttach, TeamsPacket] {
  override val id = 68
	
  override def read(in: NiolInput): TeamsPacket = {
...
final class TeamsPacketBuilder[P <: TeamsPacket] extends PacketBuilder[TeamsPacket, P =:= Complete] {
...
object TeamsPacketBuilder {
  ...
  sealed trait Entities
  sealed trait Entities
  type Complete = TeamsPacket with TeamName with Mode with TeamDisplayName with TeamPrefix with TeamSuffix with FriendlyFlags with NameTagVisibility with CollisionRule with Color with Entities with NoFields with TeamDisplayName with TeamPrefix with TeamSuffix with FriendlyFlags with NameTagVisibility with CollisionRule with Color with Entities with Entities
}

...
final class PlayerPositionAndLookPacket(var x: Double, var y: Double, var z: Double, var yaw: Float, var pitch: Float, var flags: Byte, var teleportId: Int) extends Packet[CraftAttach] {

...
import EntityTeleportPacketBuilder._
...
final class EntityTeleportPacket(var entityId: Int, var x: Double, var y: Double, var z: Double, var yaw: Byte, var pitch: Byte, var onGround: Boolean) extends Packet[CraftAttach] {
...
object EntityTeleportPacket extends PacketObj[CraftAttach, EntityTeleportPacket] {
  override val id = 76
	
  override def read(in: NiolInput): EntityTeleportPacket = {
...
final class EntityTeleportPacketBuilder[P <: EntityTeleportPacket] extends PacketBuilder[EntityTeleportPacket, P =:= Complete] {
...
object EntityTeleportPacketBuilder {
  ...
  type Complete = EntityTeleportPacket with EntityId with X with Y with Z with Yaw with Pitch with OnGround
}

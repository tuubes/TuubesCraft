...
import UpdateBlockEntityPacketBuilder._
...
final class UpdateBlockEntityPacket(var location: Long, var action: Int, var nbtData: TagCompound) extends Packet[CraftAttach] {
  ...
  override def obj = UpdateBlockEntityPacket
...
object UpdateBlockEntityPacket extends PacketObj[CraftAttach, UpdateBlockEntityPacket] {
  ...
  override def read(in: NiolInput): UpdateBlockEntityPacket = {
...
final class UpdateBlockEntityPacketBuilder[P <: UpdateBlockEntityPacket] extends PacketBuilder[UpdateBlockEntityPacket, P =:= Complete] {
...
object UpdateBlockEntityPacketBuilder {
  ...
  type Complete = UpdateBlockEntityPacket with Location with Action with NbtData
}
